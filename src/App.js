...
import PindotsHome from "./pages/pindotshome";
...
class App extends Component {
  ...
  async webviewloaded() {
    if (!window.pywebview.state) {
      ...
      } else this.setState({ options: params });
  ...
  onMenuClick() {
    if (this.focusReference) this.focusReference.current.focus();
  }
    ...
    if (!this.state.webviewready)
      return (
        <h1>
          <FormattedMessage
            id="app.loading"
            defaultMessage="Waiting webview..."
          />
        </h1>
      );
      ...
      <BrowserRouter>
        <Routes>
              ...
              <PindotsHome
                TextInputComponent={
                  <TextInput
                    ...
                    src={this.state.srctxt}
                    textcb={this.SetText}
                    options={this.state.options}
                    focusref={this.focusReference}
                  />
                }
              />
            }
          ...
          <Route
            ...
            element={
              <Layout
                focuscb={this.onMenuClick}
                status={this.state.serialstatus}
              />
            }
          >
            <Route
            ...
            <Route
              ...
              element={
                <BrailleView
                  logger={this.LogCallBack}
                  src={this.state.srctxt}
                  glouis={this.GetLouis}
                  options={this.state.options}
                  focusref={this.focusReference}
                  statuscb={this.SetStatus}
                />
              }
            />
            <Route
              ...
              element={
                <Parameters
                  ...
                  glouis={this.GetLouis}
                  options={this.state.options}
                  nblinecb={this.SetNbLine}
                  nbcolcb={this.SetNbCol}
                  comportcb={this.SetComPort}
                  optioncb={this.SetOption}
                  focusref={this.focusReference}
                />
              }
            />
