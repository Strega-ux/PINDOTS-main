...
class Parameters extends React.Component {
  ...
  handleChangeNbCol(event) {
    ...
    if (this.props.optioncb) this.props.optioncb(option);
    else this.setState({ options: option });
  }
    ...
    if (this.state.data === null)
      return (
        <p aria-hidden="true">
          <FormattedMessage
            id="param.nocomport"
            defaultMessage="Aucun port de communication"
          />
        </p>
      );
      ...
      return (
        <div>
          <p
            aria-hidden="true"
            aria-label={
              this.props.intl.formatMessage({ id: "param.labelport" }) +
              this.props.options.comport +
              " : "
            }
          >
            <FormattedMessage
              id="param.labelport"
              defaultMessage="Port de communication"
            />
  ...
  render_braille_lang() {
    if (this.state.brailleinfo.length === 0) {
      return (
        <p aria-hidden="true">
          <FormattedMessage
            id="param.nobrailletable"
            defaultMessage="Aucune table de transcription"
          />{" "}
        </p>
      );
    }
    ...
    if (this.state.options.brailletbl < this.state.brailleinfo.length)
      selectedtable =
        this.state.brailleinfo[this.state.options.brailletbl].desc;
    return (
      <>
        <p
          aria-hidden="true"
          aria-label={"Table de transcription " + selectedtable + " : "}
        >
          <FormattedMessage
            id="param.brailletable"
            defaultMessage="Table de transcription  "
          />
          <b>{selectedtable}</b>
        </p>
        <div class="form-row">
          <label htmlFor="combobraille">
            <FormattedMessage
              id="param.brailleselectlabel"
              defaultMessage="Table Braille"
            />
          </label>
          <select
            className={this.context.getStyleClass("input") + " selectbraille"}
          ...
          >
            {this.state.brailleinfo.map((item, index) => {
              if (index === this.props.options.brailletbl)
                return (
                  <option aria-selected="true" key={index} value={index}>
                    {item.lang + " - " + item.desc}
                  </option>
                );
              else
                return (
                  <option aria-selected="false" key={index} value={index}>
                    {item.lang + " - " + item.desc}
                  </option>
                );
            })}
          ...
          <fieldset>
            ...
            <div className="pure-control-group">
              <div class="form-row">
                ...
                >
                  <FormattedMessage
                    id="param.charperline"
                    defaultMessage="Nombre de caractères par ligne"
                  />
                </label>
                <input
                  type="number"
              ...
              <div class="form-row">
                ...
                >
                  <FormattedMessage
                    id="param.lineperpage"
                    defaultMessage="Nombre de lignes par page"
                  />
                </label>
                <input
                  aria-label={this.props.intl.formatMessage({
            ...
            <div className="pure-control-group">
              <div class="form-row">
                <label
                  aria-label={this.props.intl.formatMessage({
                    id: "param.linespacing_aria",
                  })}
                  htmlFor="linespacing"
                >
                  <FormattedMessage
                    id="param.linespacing"
                    defaultMessage="Interligne"
                  />
                </label>
                <select
                  ...
                  id="linespacing"
                  className={
                    this.context.getStyleClass("input") + " selectparam"
                  }
                >
            ...
            <div className="pure-control-group">
              <div class="form-row">
                <label
                  htmlFor="offsetx"
                  aria-label={this.props.intl.formatMessage({
                    id: "param.offsetx_aria",
                  })}
                >
                  <FormattedMessage
                    id="param.offsetx"
                    defaultMessage="Décalage horizontal"
                  />
                </label>
                <input
                  type="number"
              ...
              <div class="form-row">
                <label
                  htmlFor="offsety"
                  aria-label={this.props.intl.formatMessage({
                    id: "param.offsety_aria",
                  })}
                >
                  <FormattedMessage
                    id="param.offsety"
                    defaultMessage="Décalage vertical"
                  />
                </label>
                <input
                  type="number"
            ...
            <div className="pure-control-group">
              ...
              <div class="form-refresh">
                <label htmlFor="refreshbutton" aria-label="hidden"></label>
                <button
                  aria-label={this.props.intl.formatMessage({
                    id: "param.button_refresh_com_aria",
                  })}
                  className={
            ...
            <div className="pure-control-group">
              <p>
                <FormattedMessage
                  id="param.langtitle"
                  defaultMessage="Langue de l'application "
                />
